...
* AWS Certified Machine Learning ? Specialty（2021年9月）
* AWS Certified DevOps Engineer - Professional（2019年11月）
* AWS Certified Solutions Architect - Professional（2018年10月）
...
## 主な業務経歴
### 駐車場予約サービスの基盤構築【AWS/IaC（CDK、Ansible）/CICD（Codeシリーズ）/セキュリティ】（2023年）
【プロジェクト概要】AWSアーキテクチャ構成の検討・作成、セキュリティ要件実装、CI/CD構成検討・実装
構成の検討から実装、レビューまで幅広く対応

#### セキュリティ要件実装
セキュリティ関連サービスはほぼ未経験だったが（これまではセキュリティエンジニアに任せていた）、
1か月でキャッチアップし、セキュリティ要件を満たす構成をお客様に承認頂いた。

#### CI/CD
既存のCI環境を活かしながら、CD環境をAWSで構築し、最低限の構築工数で運用業務効率化を実現できる構成を提案。
開発チームにCI経験者がいなかったため、CI側の構成検討まで実施。

### IaC、CI/CD基盤の提案、要件定義【AWS/IaC（Terraform）/CICD（Codeシリーズ）】（2023年）
...
### スマホアプリ用基盤構築【AWS/IaC（Terraform）】（2022年）
...
### クラウドネイティブ化推進【AWS/セキュリティ/コンテナ】（2022年）
...
### 大規模ECサイト運用、改善提案【AWS/IaC（CDK）】（2019年～2021年）
